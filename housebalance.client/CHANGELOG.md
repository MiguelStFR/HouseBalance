...
- Crie um projeto react com create-vite: `npm init --yes vite@latest housebalance.client -- --template=react-ts`.
...
- Criar o arquivo de projeto (`housebalance.client.esproj`).
